...
```javascript
<script src="https://cdn.rawgit.com/crowdstart/checkout.js/v2.1.4/checkout.min.js"></script>
<script>
...
[checkout-image]:  https://cdn.rawgit.com/crowdstart/checkout.js/v2.1.4/examples/basic/basic_screenshot.png
[checkout.js]:     https://cdn.rawgit.com/crowdstart/checkout.js/v2.1.4/checkout.min.js
